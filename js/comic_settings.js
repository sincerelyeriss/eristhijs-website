...
// COMIC PAGE SETTINGS
const folder = "img/comics/US"; //directory of the folder where you keep all the comics
const image = "pg"; //what you'll name all your comic pages
const imgPart = "_" //special character(s) you put after the page number to subdivide pages into multiple image files (ie pg2_1, pg2_2, etc)
const ext = "png"; //file extension of your comic pages

//THUMBNAIL SETTINGS
const thumbFolder = "img/thumbs/US" //directory of the folder where you keep all the thumbnail images for the comics, in case you want the archive page to use thumbnails.
...
const pgData = [
    {
        ...
        title: "Prologue", //the title of the page (leaving this blank will default it to "Page X")
        ...
        authorNotes: `
            <p>A little sneak peek into the first chapter of Unsung Stars!!</p>
            `,
    },
    {
        pgNum: 2,
        title: "Prologue",
        date: writeDate(2025, 1, 27),
